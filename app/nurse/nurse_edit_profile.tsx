...
export default function NurseEditProfile() {
  ...
  const onSave = async () => {
    try {
      ...
      const updatedUser = {
        ...
        avatar_uri: data?.avatar_uri ?? avatarUri ?? user.avatar_uri,
      };
      ...
      <View style={styles.container}>
        ...
        <View style={[styles.header, { paddingTop: insets.top }]}> 
          ...
          <View style={styles.headerIcons}>
            ...
            <TouchableOpacity style={styles.iconBtn} onPress={() => navigation.navigate('NurseProfile')}>
