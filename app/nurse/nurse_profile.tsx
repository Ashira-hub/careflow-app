            ...
            <View style={styles.profileCard}>
              ...
              <View style={{ flex: 1 }}>
                <View style={styles.nameRow}>
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('NurseEditProfile')} activeOpacity={0.85}>
        ...
        {showProfileMenu && (
          <View style={styles.dropdownOverlay}>
            ...
            <View style={[styles.dropdownCard, { top: insets.top + 48, right: 16 }]}> 
              <TouchableOpacity style={styles.dropdownItem} onPress={() => { setShowProfileMenu(false); /* already here */ }}>
