  ...
  useFocusEffect(React.useCallback(() => {
    ...
    (async () => {
      try {
        ...
        const next = [{ id: String(Date.now()), title: 'Viewed Profile', type: 'profile', timestamp: Date.now() }, ...(Array.isArray(arr) ? arr : [])].slice(0, 100);
          ...
          <View style={{ paddingHorizontal: 16, paddingTop: 12 }}>
            ...
            <View style={styles.profileCard}>
              <View style={styles.avatar}> 
                ...
                <TouchableOpacity style={styles.avatarPen} onPress={pickImage}>
              ...
              <View style={{ flex: 1 }}>
                <View style={styles.nameRow}>
                  ...
                  <TouchableOpacity onPress={() => navigation.navigate('SupervisorEditProfile' as never)} activeOpacity={0.85}>
            ...
            <View style={styles.buttonsRow}>
              <TouchableOpacity style={styles.logoutBtn} activeOpacity={0.9} onPress={async () => {
                try { await AsyncStorage.multiRemove(['session','supervisor_activity']); } catch {}
